<template>
  <div class="bg-gray-100 h-60 flex rounded-3xl mx-6">
    <div
      class="h-60 flex w-75 rounded-3xl relative bg-brandbook data-brandbook-id={{ item.brandbook_style_id }}"
...
import { brandbookIdToColorMapper, type Product } from '../api/product.ts';
